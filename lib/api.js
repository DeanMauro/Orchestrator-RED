...
class Api {
	...
	static HostLicenses(action) {
		return {
			...
			GetById: ["get", "/odata/HostLicenses({Id})"],
	...
	static QueueDefinitions(action) {
		return {
			...
			GetById: ["get", "/odata/QueueDefinitions"],
	...
	static QueueProcessingRecords(action) {
		return {
			...
			GetById: ["get", "/odata/QueueProcessingRecords({Id})"],
	...
	static UserLoginAttempts(action) {
		return {
			GetById: ["get", "/odata/UserLoginAttempts({Id})"]
		}[action]
	}
