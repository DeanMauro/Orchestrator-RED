...
class swaggerFermenter {
	...
	distill() {
		...
		var exclusions = new RegExp("^(/api/Account|/api/RobotsService|/api/Status|/odata/HostLicenses|/odata//MessageTemplates|/odata/Settings|/api/Translations|/odata/UserLoginAttempts)");
